...
/* jboolean type methods */

/** Create a new empty json_object of type json_type_boolean
 * @param b a jboolean TRUE or FALSE (0 or 1)
 * @returns a json_object of type json_type_boolean
 */
extern struct json_object* json_object_new_boolean(jboolean b);

/** Get the jboolean value of a json_object
 *
 * The type is coerced to a jboolean if the passed object is not a jboolean.
 ...
 * @returns a jboolean
 */
extern jboolean json_object_get_boolean(struct json_object *obj);
